...
\centerline{\normalsize{求职意向：大模型算法工程师 / AI 算法工程师 / 计算机视觉算法工程师}} 
    
\section{\makebox[\widthof{\faGraduationCap}][c]{\color{CVBlue}\faGraduationCap}\ 教育背景}    
\textbf{浙江大学} \hfill 本科\\[0.5em] % 标题和正文间加一点距离
控制工程专业
\begin{itemize}[nosep]
    \item 政治面貌：共青团员；籍贯：四川省遂宁市船山区；出生年月：2002.10
\end{itemize}

\section{\makebox[\widthof{\faCogs}][c]{\color{CVBlue}\faCogs}\ 专业技能}
\begin{itemize}[nosep]
    \item \textbf{编程语言：} Python、C
    \item \textbf{算法方向：} 深度学习、目标检测、图像识别、时序预测、故障诊断
    \item \textbf{模型框架：} YOLOv5 模型改进、数据集制作、模型训练与调优
    \item \textbf{工程能力：} 算法落地、平台开发适配、专利/软著/论文成果转化
    \item \textbf{英语能力：} CET-6（481 分）
\end{itemize}
